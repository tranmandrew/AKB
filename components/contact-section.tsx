        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="heading-primary text-3xl md:text-5xl text-foreground mb-6 text-balance">
              Connect With <span className="heading-primary text-accent">Us</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="glass-card border-0">
              <CardContent className="p-8">
                <h3 className="font-montserrat text-xl font-semibold text-foreground mb-6">Get in Touch</h3>
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="font-montserrat text-sm font-medium text-foreground mb-2 block">First Name</label>
                  ...
                  <div>
                    <label className="font-montserrat text-sm font-medium text-foreground mb-2 block">Email</label>
                    <Input type="email" placeholder="your.email@company.com" />
                  </div>
                  <div>
                    <label className="font-montserrat text-sm font-medium text-foreground mb-2 block">Company</label>
                    <Input placeholder="Your current company" />
                  </div>
                  <div>
                    <label className="font-montserrat text-sm font-medium text-foreground mb-2 block">Message</label>
                    <Textarea placeholder="Tell us about your interest in joining the Association..." rows={4} />
                  </div>
                  <Button className="font-montserrat w-full bg-accent hover:bg-accent/90 text-accent-foreground">Send Message</Button>
                </form>
              </CardContent>
            </Card>
            ...
            <div className="space-y-8">
              <Card className="glass-card border-0">
                <CardContent className="p-8">
                  <h3 className="font-montserrat text-xl font-semibold text-foreground mb-6">Contact Information</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              {/* Organization Info */}
              <div>
                <h4 className="font-montserrat font-semibold text-foreground mb-4">Association of Professional Kiều Bào</h4>
              ...
              <div>
                <h4 className="font-montserrat font-semibold text-foreground mb-4">Follow Our Journey</h4>
                <div className="mb-4">
                  <a
                    href="#"
