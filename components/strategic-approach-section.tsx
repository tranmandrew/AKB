...
export function StrategicApproachSection() {
  ...
  return (
    <section id="strategy" className="scroll-snap-section relative py-16 md:py-20 bg-black overflow-hidden min-h-screen md:h-screen diagonal-top-bottom flex items-center scroll-mt-24">
