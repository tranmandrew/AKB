      ...
      <div className={`text-center ${className}`}>
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 max-w-6xl mx-auto">
          {displayLogos.map((logo, index) => (
            <div
              key={logo.name}
              className="flex-shrink-0 hover:scale-110 cursor-pointer relative transition-all duration-300 flex items-center justify-center w-36 h-20 bg-white/5 rounded-lg border border-white/10"
