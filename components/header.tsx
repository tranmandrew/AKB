  ...
  return (
    <header
      ...
      style={{
        ...
        backgroundColor: `rgba(255, 255, 255, ${0.4 + scrollProgress * 0.1})`,
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-3 items-center">
          ...
          <div className="flex items-center space-x-3 justify-self-start">
            <Link href="/" className="flex items-center space-x-3 group">
              <div
                className="flex items-center justify-center transition-all duration-300 ease-out group-hover:scale-105 overflow-hidden"
                style={{
              ...
              <div className="overflow-hidden hidden sm:block">
                <span
                  className="font-semibold text-foreground transition-all duration-500 ease-out whitespace-nowrap block"
                  style={{
            ...
            >
              {[
                ...
                <button
                  ...
                  className="relative text-vietnam-red hover:text-vietnam-red/80 font-medium hover:scale-105 group text-sm flex items-center justify-center min-h-[2.5rem] transition-colors duration-200"
                  style={{
            ...
            >
              ...
              <Link href="/contact">
                <Button
                  ...
                  style={{
                    paddingLeft: `${1.25 - scrollProgress * 0.3}rem`,
                    paddingRight: `${1.25 - scrollProgress * 0.3}rem`,
                    paddingTop: `${0.6 - scrollProgress * 0.1}rem`,
                    paddingBottom: `${0.6 - scrollProgress * 0.1}rem`,
                    fontSize: `${0.875 - scrollProgress * 0.1}rem`,
        ...
        {/* Mobile Navigation - Fixed sliding menu */}
        <div
          className={`
            lg:hidden overflow-hidden transition-all duration-500 ease-out bg-background/95 backdrop-blur-lg border-t border-border/30
            ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}
          `}
        >
          <nav className="pt-4 pb-4 px-4">
            <div className="flex flex-col space-y-2">
              {[
                ...
                <button
                  ...
                  onClick={() => scrollToSection(item.id)}
                  className={`
                    text-left py-3 px-4 rounded-lg text-vietnam-red hover:text-vietnam-red/80
                    hover:bg-vietnam-red/10 transition-all duration-200 font-medium
                    border border-transparent hover:border-vietnam-red/20
              ...
              <Link
                href="/contact"
                className={`
                  block text-left py-3 px-4 rounded-lg text-vietnam-red hover:text-vietnam-red/80
                  hover:bg-vietnam-red/10 transition-all duration-200 font-medium
                  border border-transparent hover:border-vietnam-red/20
                  transform transition-transform duration-300
                  ${isMenuOpen ? 'translate-x-0' : '-translate-x-4'}
            ...
            <div
              className={`
                flex flex-col space-y-3 pt-4 mt-4 border-t border-border/30
            ...
            >
              <Button
                variant="outline"
                className="justify-center border-border/50 hover:border-vietnam-red/50 hover:bg-vietnam-red/5 bg-background"
                onClick={() => scrollToSection('about')}
              >
                Learn More
              </Button>
              <Link href="/contact">
                <Button className="w-full bg-vietnam-red hover:bg-vietnam-red/90 text-white font-semibold shadow-lg">
                  Join the Movement
                </Button>
              </Link>
            </div>
