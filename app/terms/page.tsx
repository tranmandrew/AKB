        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1 prose prose-neutral dark:prose-invert max-w-none">
            <section id="acceptance" className="mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                These Terms of Service constitute a legally binding agreement between you and the Association of Professional Kiều Bào, recognized under Resolution 36-NQ/TW of the Politburo of Vietnam.
              </p>
            </section>

            <section id="organization" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">2. Organization Description</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Association of Professional Kiều Bào is a distinguished organization formally recognized by Resolution 36-NQ/TW of the Politburo as an integral part of the Vietnamese national community. Our mission is to connect global Vietnamese excellence with Vietnam's strategic development.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="membership" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">3. Membership Requirements</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="conduct" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">4. Professional Conduct</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="government" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">5. Government Relations</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="intellectual" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">6. Intellectual Property</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="confidentiality" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">7. Confidentiality</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="networking" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">8. Networking Events</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="termination" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">9. Membership Termination</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="liability" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">10. Limitation of Liability</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="governing" className="mb-12">
              <h2 className="text-2xl font-medium text-foreground mb-4">11. Governing Law</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
